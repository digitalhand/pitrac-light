...
cd c:\kata\PiTrac\Software\LMSourceCode\src
code gs_camera.cpp
```
...
```bash
# Tab 1: Project root
cd c:\kata\PiTrac\Software\LMSourceCode\src\ImageAnalysis

# Tab 2: Build directory
cd c:\kata\PiTrac\Software\LMSourceCode\src\ImageAnalysis\build
