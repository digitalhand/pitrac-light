...
export PITRAC_COMMON_CMD_LINE_ARGS=" --config_file $PITRAC_ROOT/src/golf_sim_config.json --msg_broker_address $PITRAC_MSG_BROKER_FULL_ADDRESS $PITRAC_SIM_ARG --web_server_share_dir $PITRAC_WEBSERVER_SHARE_DIR --base_image_logging_dir $PITRAC_BASE_IMAGE_LOGGING_DIR "
